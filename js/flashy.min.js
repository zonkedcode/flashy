...
Flashy.AnimatedClass={Animated:'animated',AnimatedBounceRight:'bounceOutRight',AnimatedInRight:'bounceInRight'};function StringifyOptions(){Flashy.OPTIONS_COPY=JSON.parse(JSON.stringify(Flashy.OPTIONS))}
...
Flashy.Quit=function(){$(document).on('click',Flashy.ClassName.iconChild,function(e){Flashy.Out()});return this}
